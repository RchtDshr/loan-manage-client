    ...
    <div className="max-w-md mx-auto box">
      ...
      <div className="mb-4">
        ...
        <input
          type="number"
          min="0"
          className="mt-1 block py-1 bg-green-200 pl-1 border rounded-md w-full"
          placeholder='Total amount of loan in Rs'
          value={amount}
      ...
      <button
        className="btn text-white px-4 py-2 rounded flex items-center justify-center" 
